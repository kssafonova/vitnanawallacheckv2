(() => {
  ...
  class SiteFooter extends HTMLElement{
    connectedCallback(){
      ...
      .footer{background:#050505;color:#efeeed;padding:clamp(56px,8vw,96px) var(--ui-pad,20px) calc(22px + env(safe-area-inset-bottom));border-top:1px solid #292927}.in{width:min(100%,var(--ui-max,1680px));margin:auto}
      ...
      a,p{display:block;margin:0 0 10px;color:#d2d1d0;font-size:var(--fs-small,13px);line-height:1.45}a:hover{opacity:.62}
      ...
      <footer class="footer"><div class="in">
        ...
        <div class="grid">
          ...
          <div><h3>Проект</h3><a href="${base}catalog/">Готовые конфигурации</a><a href="${base}index.html#projects">Проекты</a><a href="${base}raschet/">Калькулятор</a></div>
