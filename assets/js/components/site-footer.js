(() => {
  ...
  class SiteFooter extends HTMLElement{
    connectedCallback(){
      ...
      .footer{background:#050505;color:#f1f0eb;padding:clamp(56px,8vw,96px) var(--ui-pad,20px) calc(22px + env(safe-area-inset-bottom));border-top:1px solid #292927}.in{width:min(100%,var(--ui-max,1680px));margin:auto}
